...
def analyze_historical_market(
    ...
    *,
    ...
    return HistoricalReadReport(
        ...
        market_type_counts=_count(
            snapshot.sideways_market.market_type for snapshot in snapshots
        ),
...
def _audit_reasons(
    ...
    *,
    ...
    if previous_snapshot is not None:
        ...
        if (
            snapshot.sideways_market.market_type
            != previous_snapshot.sideways_market.market_type
        ):
